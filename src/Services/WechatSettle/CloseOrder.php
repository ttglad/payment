...
class CloseOrder extends WechatSettleBaseService implements IRequestContract
{
    protected $needsKey = [];
    ...
    public function request(array $requestParams)
    {
        try {
            ...
            $url = sprintf($this->gatewayUrl, sprintf(WechatSettleConst::CLOSE_ORDER_METHOD, $param['combine_out_trade_no']));
            unset($param['combine_out_trade_no']);
            ...
            if (200 != $data->getStatusCode() && 204 != $data->getStatusCode()) {
