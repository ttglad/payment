...
class LitePay extends WechatSettleBaseService implements IRequestContract
{
    protected $needsKey = [];
    ...
    {
        try {
            $url = sprintf($this->gatewayUrl, WechatSettleConst::LITE_PAY_METHOD);
...
//        $selfParams['scene_info']['h5_info']['type'] = 'Wap';
