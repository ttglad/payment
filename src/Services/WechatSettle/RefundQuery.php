...
class RefundQuery extends WechatSettleBaseService implements IRequestContract
{
    protected $needsKey = [];
    ...
    public function request(array $requestParams)
    {
        try {
            ...
            $url = sprintf($this->gatewayUrl, sprintf(WechatSettleConst::REFUND_QUERY_METHOD, $param['out_refund_no'])) . '?sub_mchid=' . $param['sub_mchid'];
