...
class BarPay extends WechatBaseService implements IRequestContract
{
    protected $needsKey = ['appid', 'mch_id', 'nonce_str', 'sign', 'body', 'out_trade_no', 'total_fee',
        'spbill_create_ip', 'notify_url', 'auth_code'];
    ...
    {
        try {
            $ret = $this->requestXml(WechatConst::BAR_PAY_METHOD, $requestParams);
