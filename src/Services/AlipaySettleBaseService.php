        ...
        if (!empty($goods)) {
            foreach ($goods as $_goods) {
                ...
                $info =  [
                    ...
                    'alipay_goods_id' => $_goods['goods_id_third'] ?? '',
                    'goods_name' => $_goods['goods_name'] ?? '',
                    'quantity' => $_goods['goods_quantity'] ?? '',
                    'price' => DataHelper::amountFormat($_goods['goods_price']),
                    'goods_category' => $_goods['goods_category'] ?? '',
                    'categories_tree' => $_goods['goods_categories_tree'] ?? '',
                    'body' => $_goods['goods_body'] ?? '',
                    'show_url' => $_goods['goods_url'] ?? '',
                ];
                $return[] = $info;
            }
        }
