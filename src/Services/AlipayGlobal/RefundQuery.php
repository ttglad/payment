...
class RefundQuery extends AlipayGlobalBaseService implements IRequestContract
{
    ...
    {
        try {
            $param = $this->buildParam(AlipayGlobalConst::REFUND_QUERY_METHOD, $requestParams);
