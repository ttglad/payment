...
class WebPay extends AlipayGlobalBaseService implements IRequestContract
{
    ...
    {
        try {
            $param = $this->buildParam(AlipayGlobalConst::WEB_PAY_METHOD, $requestParams);
...
//            'seller_id' => $requestParams['seller_id'] ?? '',
            ...
            'product_code' => $requestParams['product_code'] ?? 'NEW_OVERSEAS_SELLER',
