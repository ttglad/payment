...
class TradeQuery extends AlipaySettleBaseService implements IRequestContract
{
    ...
    {
        try {
            $param = $this->buildParam(AlipaySettleConst::TRADE_QUERY_METHOD, $requestParams);
            ...
            $content = $retArray['alipay_trade_query_response'];
