...
class QrPay extends UnionBaseService implements IRequestContract
{
    ...
    {
        try {
            $url = sprintf($this->gatewayUrl, UnionConst::QR_PAY_METHOD);
    ...
    public function getSelfParams(array $requestParams)
    {
        ...
        $selfParams = [
            ...
            'txnSubType' => $requestParams['txn_sub_type'] ?? '07',
            ...
            'payTimeout' => $requestParams['pay_timeout'] ?? '',
        ];
