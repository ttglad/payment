...
class CloseOrder extends AlipayBaseService implements IRequestContract
{
    ...
    {
        try {
            $param = $this->buildParam(AlipayConst::CLOSE_ORDER_METHOD, $requestParams);
            ...
            $content = $retArray['alipay_trade_close_response'];
