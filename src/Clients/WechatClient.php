...
use Ttglad\Payment\Services\Wechat\CancelOrder;
use Ttglad\Payment\Services\Wechat\CloseOrder;
use Ttglad\Payment\Services\Wechat\RefundQuery;
use Ttglad\Payment\Services\Wechat\TradeQuery;
use Ttglad\Payment\Services\Wechat\TradeRefund;


class WechatClient extends Client implements IPayContract
{
    /**
    ...
    public function pay(string $channel, array $requestParams)
    {
        ...
        $className = "Ttglad\\Payment\\Services\\Wechat\\{$class}Pay";
